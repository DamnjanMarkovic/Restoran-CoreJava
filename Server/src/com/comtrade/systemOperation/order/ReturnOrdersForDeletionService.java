...
public class ReturnOrdersForDeletionService extends com.comtrade.systemOperation.GenericSystemOperation {
    @Override
    public void executeSpecificOperation(TransferClass transferClass) throws SQLException, InterruptedException, IOException {
        ...
        transferClass.setResponse(broker.returnOrdersForDeletion(restaurantID));
